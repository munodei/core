                                                    ...
                                                    <div class="calculator-country-select-wrapper">
                                                        <select name="fromCountries" id="fromCountries"
                                                            ...
                                                            @foreach($country as $data)
                                                                <option @if($data->id ==auth()->user()->country_id) selected @endif value="{{$data->id}}" data-id="{{$data->id}}" data-code="{{$data->code}}"
                                                                        data-rate="{{$data->rate}}"
                                                                        data-charge="{{$data->transfer_charge}}"
