                ...
                <div class="tile-body">
                    <form role="form" method="POST" action="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-md-3">
                                <h6 class="text-uppercase">Merchant Profit <small>(Sending)</small> </h6>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{$general->sending_charge}}"
                                           name="sending_charge">
                                    <div class="input-group-append"><span class="input-group-text">%</span></div>
                                </div>
                                <small class="form-text text-muted" >Merchant will  get amount from sending Charge</small>
                                <span class="text-danger">{{ $errors->first('sending_charge') }}</span>
                            </div>

                            <div class="form-group  col-md-3">
                                <h6 class="text-uppercase">Merchant Profit <small>(Receiving)</small> </h6>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{$general->withdraw_charge}}"
                                           name="withdraw_charge">
                                    <div class="input-group-append"><span class="input-group-text">%</span></div>
                                </div>
                                <small class="form-text text-muted" >Merchant will  get amount from receiving Charge</small>
