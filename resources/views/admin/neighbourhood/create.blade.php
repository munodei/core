...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title "> Add Neighbourhood
                ...
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('neighbourhood.store')}}" name="editForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{old('neighbourhood')}}"
                                           name="neighbourhood">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('neighbourhood_description') }}" name="neighbourhood_description">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <button class="btn btn-primary btn-block btn-lg">Save Neighbourhood</button>
                            </div>
                        </div>
                    </form>
                </div>
