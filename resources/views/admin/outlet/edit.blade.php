        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title "> Add Outlet
                    <a href="{{route('outlet.index')}}" class="btn btn-success btn-md pull-right ">
                        <i class="fa fa-eye"></i> All Outlets
                    </a>
                </h3><br>

                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('outlet.update',$outlet)}}" name="editForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="outlet_cat_id" id="outlet_cat_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($outlet_cat as $data)
                                        <option @if(old('outlet_cat_id')===$data->id || $outlet->outletCatId == $data->id) selected @endif value="{{$data->id}}">{{$data->outlet_cat_des}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('outlet_desc') ?? $outlet->outlet_desc ?? '' }}" name="outlet_desc">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('outlet_photo') ?? $outlet->outlet_photo ?? '' }}" name="outlet_photo">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('outtlet_long') ?? $outlet->outtlet_long ?? '' }}" name="outtlet_long">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('outlet_lat') ?? $outlet->outlet_lat ?? '' }}" name="outlet_lat">
                                </div>
                                @if ($errors->has('outtlet_long'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="country_id" id="country_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($country as $data)
                                        <option @if(old('country_id')===$data->id || $outlet->country_id ===$data->id  ) selected @endif value="{{$data->id}}">{{$data->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="state_id" id="state_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($state as $data)
                                        <option @if(old('state_id')===$data->id || $outlet->state_id ===$data->id) selected @endif  value="{{$data->id}}">{{$data->state}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="city_id" id="city_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($city as $data)
                                        <option @if(old('city_id')===$data->id || $outlet->city_id ===$data->id) selected @endif value="{{$data->id}}">{{$data->city}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="neighbourhood_id" id="neighbourhood_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($neighbourhood as $data)
                                        <option @if( old('neighbourhood_id')=== $data->id || $outlet->neighbourhood_id ===$data->id) selected @endif value="{{$data->id}}">{{$data->neighbourhood}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="suburb_id" id="suburb_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($suburb as $data)
                                        <option @if(old('suburb_id')===$data->id || $outlet->suburb_id ===$data->id) selected @endif value="{{$data->id}}">{{$data->suburb}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('address') ?? $outlet->address ?? ''  }}" name="address">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <h5>Outlet phone:</h5>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('phone') ?? $outlet->phone ?? ''  }}" name="phone">
                                </div>
                                @if ($errors->has('phone'))
                            ...
                            <div class="form-group col-md-6">
                                <h5>Outlet email:</h5>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('email') ?? $outlet->email ?? ''  }}" name="email">
                                </div>
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('website') ?? $outlet->website ?? ''  }}" name="website">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <textarea type="text" class="form-control form-control-lg"  name="open_time">{{ old('open_time') ?? $outlet->open_time ?? '' }}</textarea>
                                </div>
