    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('outlet-cat.update',$outlet_cat)}}" name="editForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('outlet_cat') ?? $outlet_cat->outlet_cat ?? '' }}"
                                           name="outlet_cat">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('outlet_cat_des') ?? $outlet_cat->outlet_cat_des ?? '' }}" name="outlet_cat_des">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <h5>Status:</h5>
                                <input data-toggle="toggle" data-size="large" value="1" data-onstyle="success" @if($outlet_cat->status === 1 || old('status') ==='on') checked @endif
