                ...
                <div class="tile-body">
                    <form role="form" method="POST" action="" name="editForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-10 offset-md-1">
                                <h5>Details</h5>
                                <textarea name="details" id="area1"  rows="12" class="form-control form-control-lg"></textarea>
                            </div>

                            <div class="form-group col-md-10 offset-md-1">
                                <h5>Status</h5>
                                <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="large" data-width="100%" type="checkbox" name="status">
                            </div>
                            <div class="form-group col-md-10 offset-md-1">
