        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    {!! Form::model($faqs,['route'=>['service-faqs-update',$faqs->id],'method'=>'put','role'=>'form','class'=>'form-horizontal','files'=>true]) !!}
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="form-group">
                                  <label class="col-md-12"><strong style="text-transform: uppercase;">service</strong></label>
                                  <div class="col-md-12 ">
                                      <select name="service_id" class="form-control form-control-lg"/>
                                        @foreach($services as $service)
                                          <option  @if($faqs->service_id == $service->id) @endif value="{{ $service->id }}">{{ $service->service }}</option>
                                        @endforeach
                                    </select>
                                  </div>
                              </div>
