        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-title ">
                    All Faq
                    <a href="{{route('service-faqs-create')}}" class="btn btn-success btn-md pull-right ">
                        <i class="fa fa-plus"></i> Create Service Faqs
                    </a>
                    <br>
                </div>
                ...
                <div class="tile-body">
                    <div id="accordion">
                        ...
                        @foreach($faqs1 as  $key=>$fg)

                          @foreach($fg->faqs as  $key=>$f)
                                  ...
                                  <div class="card" style="margin: 15px 0;">
                                      ...
                                      <div id="collapseOne{{ $f->id }}" class="collapse @if($key == 0) show @endif" aria-labelledby="headingOne" data-parent="#accordion">
                                          <div class="card-body">
                                              ...
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <a href="{{ route('service-faqs-edit',$f->id) }}" class="btn btn-primary btn-block bold uppercase"><i class="fa fa-edit"></i> Edit faqs</a>
                                                  </div>
                                                  <div class="col-md-6">
    ...
    <div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('service-faqs-delete') }}" >
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
