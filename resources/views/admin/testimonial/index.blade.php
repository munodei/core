...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Frontend Text</h3>
                ...
                <div class="tile-body">
                    <form action="{{route('testimonial.text')}}" method="post">
                        ...
                        <div class="form-group col-md-10 offset-md-1">
                            ...
                            <div class="">
                                <div class="input-group">
                                    <input type="text" name="testimonial_h" class="form-control form-control-lg" placeholder="Title"
                                           value="{{ $basic->testimonial_h }}" >
                        ...
                        <div class="form-group  col-md-10 offset-md-1">
                            <h5>Sort Details</h5>
                            <textarea name="testimonial_p" class="form-control-lg form-control" placeholder="Details"  rows="3">{{$basic->testimonial_p}}</textarea>
                        </div>
