            ...
            <div class="tile-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        ...
                        <textarea name="message" id="" class="form-control form-control-lg"  rows="5" placeholder="Write Message.." required></textarea>
                    </div>
                </div>
...
<div class="col-md-4">
    <div class="tile">
        ...
        <div class="tile-body">
            ...
            <h6>BALANCE : {{number_format(floatval($user->balance), $basic->decimal, '.', '')}} {{$basic->currency}}</h6>
            <hr>
