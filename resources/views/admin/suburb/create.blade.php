...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title "> Add Suburb
                ...
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('suburb.store')}}" name="editForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{old('suburb')}}"
                                           name="suburb">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="neighbourhood_id" id="neighbourhood_id" class="form-control form-control-lg">
                                    ...
                                    @foreach($neighbourhood as $data)
                                        <option value="{{$data->id}}">{{$data->neighbourhood}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" value="{{ old('suburb_description') }}" name="suburb_description">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <button class="btn btn-primary btn-block btn-lg">Save Suburb</button>
                            </div>
                        </div>
                    </form>
                </div>
