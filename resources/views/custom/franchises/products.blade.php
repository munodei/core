    ...
    <div class="col">
      ...
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
          ...
          <li class="breadcrumb-item active"><a href="{{ url()->current() }}">Products</a></li>
      </ul>
    </div>
...
<div class="row filter-row">
    ...
    <div class="col-sm-6 col-md-3">
      <div class="form-group form-focus">
        <form  method="post" action = "{{ url()->current() }}" id="searchform"  value="{{ request('product')  }}"  autocomplete="off">
                                @csrf
        <input type="text" class="form-control floating" name="product" value="{{ request('product')  }}"  autocomplete="off">
        </form>
...
<div class="row staff-grid-row">
  ...
  @if(count($products) >0)
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
              ...
              <div class="profile-img">
                <a href="#" class="avatar"><center><img src="{{ $data->photo }}" alt="{{ $data->outlet }}" width="100%" height="100%"/></center></a>
              </div>
      ...
      <div class="col-md-12 col-sm-12 col-12 col-lg-12 col-xl-12">
          <center> No products provided available for this franchise!!</center>
      </div>
