...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-money"></i> {{ $page_title }} (Please Note That We Buy AirTime Only)</h1>
        </div>
    ...
    <div class="row">
        ...
        @foreach($networks as $gate)
            <div class="col-md-3">
                <div class="tile text-center">
                    <h3 class="tile-title">{{$gate->name}} </h3>
                    <div class="tile-body">
                        <img class="card-img-top"
                             src="{{asset('assets/images/')}}/{{ $gate->logo }}"
                ...
                <div class="modal fade" id="depositModal{{$gate->id}}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{route('sell-airtime-preview')}}">
                                @csrf
                                <input type="hidden" name="network_id" id="network_id" value="{{$gate->id}}"/>
