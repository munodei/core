                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3" >
                                <ul class="list-group">
                                    ...
                                    <input type="hidden" name='amount_to_be_deposited' value="{{ $data['amount'] * (intval($network->percent_charge)/100) + $network->fixed_charge  }}"/>
                                    ...
                                    <li class="list-group-item "> Airtime Type:
                                      <div class="btn-wrapper">
                                          <select class="form-control" name ='airtime_type'>
