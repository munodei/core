          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
              <div class="profile-img">
                <a href="{{ route('nhbrc-professional-references.edit',$data) }}" class="avatar"><img src="{{ url('/') }}{{ $data->client_picture }}" alt="{{$data->firstname}} {{$data->lastname}}" width="80px" height="80px"></a>
              </div>
