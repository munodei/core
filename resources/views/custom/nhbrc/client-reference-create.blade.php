  ...
  <div class="row align-items-center">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('nhbrc-clients-references.store')}}" name="createClientReference" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="date" name="date_completed" value="{{old('date_completed')}}" class="form-control form-control-lg" placeholder="Date Completed" >
                                </div>
                           ...
                           <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="price_of_contract" value="{{old('price_of_contract')}}" class="form-control form-control-lg" placeholder="Price of Contract" >
                                </div>
                           ...
                           <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="file" name="contract" value="{{old('contract')}}" class="form-control form-control-lg" placeholder="Contract Document" >
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="file" name="client_picture" value="{{old('client_picture')}}" class="form-control form-control-lg" placeholder="Client Picture" >
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="file" name="client_id" value="{{old('client_id')}}" class="form-control form-control-lg" placeholder="Client Proof Document" >
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <button class="btn btn-primary btn-block btn-lg">Save New Client Reference</button>
                            </div>
                        </div>
