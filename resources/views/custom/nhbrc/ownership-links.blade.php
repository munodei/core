  ...
  <div class="row align-items-center">
    <div class="col">
      ...
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Company Directors Ownership Links</li>
      </ul>
    </div>
...
<div class="row staff-grid-row">
  ...
  @if(count($directors) >0)
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
              <div class="profile-img">
                <a href="{{ route('nhbrc-ownership-links.edit',$data) }}" class="avatar"><img src="{{ $data->photo }}" alt="{{$data->firstname}} {{$data->lastname}}" width="80px" height="80px"></a>
              </div>
              ...
              <div class="small text-muted">has Ownership Links with</div>
      ...
      @else
      <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
          <center> You don't have any Company Directors with Ownership Links!!</center>
      </div>
