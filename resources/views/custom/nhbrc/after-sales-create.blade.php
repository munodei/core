...
<div class="page-header">
  <div class="row align-items-center">
    ...
    <div class="col-auto float-right ml-auto">
      <a href="{{ route('nhbrc-after-sales.create') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add Company  After Sales Customer Service</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('nhbrc-after-sales.store')}}" name="createClientReference" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <select name="contact_type" class="form-control form-control-lg" required>
                                        <option @if(old('contact_type')==='' ) selected @endif value="">Contact Type</option>
                                        <option @if(old('contact_type')==='Customer Service' ) selected @endif value="Customer Service">Customer Service</option>
                                        <option @if(old('contact_type')==='Main Contact') selected @endif value="Main Contact">Main Contact</option>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <button class="btn btn-primary btn-block btn-lg">Save New Company After Sales Customer Service Agent</button>
                            </div>
                        </div>
