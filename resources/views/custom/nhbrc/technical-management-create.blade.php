  ...
  <div class="row align-items-center">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('nhbrc-technical-management.store')}}" name="createClientReference" enctype="multipart/form-data">
                        @csrf
                             ...
                             <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <select name="type" class="form-control form-control-lg">
                                        <option @if(old('type')==='' ) selected @endif value="">Select Quality Control Person</option>
                                        <option @if(old('type')==='In House' ) selected @endif value="In House">In House</option>
                                        <option @if(old('type')==='Engineering Firm') selected @endif value="Engineering Firm">Engineering Firm</option>
                                        <option @if(old('type')==='Contrator') selected @endif value="Contrator">Contrator</option>
                                    </select>
                                </div>
                                @if ($errors->has('type'))
                           ...
                           <div class="form-group col-md-2">
                            ...
                            <div class="field form-group col-md-3">
                                <label for="highest_education_qualification">Highest Education Qualification <span style="color:red;" aria-hidden="true">*</span></label>
                                  <select class="form-control" name="highest_education_qualification" id="highest_education_qualification" required>
                                   @foreach($highest_education_qualifications as $highest_education_qualification)
                                      <option @if(old('highest_education_qualification')===$highest_education_qualification->education_qualification )selected @endif value="{{ $highest_education_qualification->education_qualification }}">{{ $highest_education_qualification->education_qualification }}</option>
                                   @endforeach
                                </select>
                              </div>
                             ...
                             <div class="form-group col-md-12">
                                <h4>Experience</h4>
                                <div class="input-group">
                                    <textarea name="experience" rows="4" id="experience" class="form-control form-control-lg" required>{{old('experience')}}</textarea>
                                </div>
                            ...
                            <div class="field form-group col-md-12">
                              <label>Has this Person received a copy of the Home Building Manual?<span style="color:red;" aria-hidden="true">&nbsp;*</span></label>
                                <br>
                                    <label>
                                      <input type="radio"  name="received_copy" id="received_copy" value="No" set="No" aria-required="true" @if(old('received_copy')=="No"  )checked @endif @if(old('received_copy')==null) checked @endif>&nbsp;&nbsp;No
                                    </label>
                                    <br>
                                    <label>
                                      <input type="radio"  name="received_copy" id="received_copy"  value="Yes" set="Yes" aria-required="true" @if(old('received_copy')=="Yes"  )checked @endif>&nbsp;&nbsp;Yes
                                    </label>
                                    <br>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <button class="btn btn-primary btn-block btn-lg">Save New Technical Management</button>
                            </div>
                        </div>
