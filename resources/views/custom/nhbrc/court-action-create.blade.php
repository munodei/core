  ...
  <div class="row align-items-center">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('nhbrc-court-actions.store')}}" name="editForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="bargain_council_registration_number" value="{{old('bargain_council_registration_number')}}" class="form-control form-control-lg" placeholder="Bargain Council Registration Number">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <button class="btn btn-primary btn-block btn-lg">Save New Company Director Court Action</button>
                            </div>
                        </div>
