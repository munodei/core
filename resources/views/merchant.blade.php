...
<header class="app-header"><a class="app-header__logo" href="{{url('/')}}">{{$basic->sitename}}</a>
    ...
    <ul class="app-nav">
        <!-- User Menu-->
        <li style="background: #339973;"><a class="app-nav__item" href="#"> <i
                    class="fa fa-money fa-lg"> {{number_format(Auth::user()->balance, $basic->decimal) }} {{ $basic->currency}} </i></a>
        </li>
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i> {{Auth::user()->fname}}</a>
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a class="dropdown-item" href="{{route('user.change-password')}}"><i class="fa fa-key fa-lg"></i>
                        Password</a></li>
                <li><a class="dropdown-item" href="{{route('edit-profile')}}"><i class="fa fa-user fa-lg"></i>
                        Profile</a></li>
                <li><a class="dropdown-item"  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out fa-lg"></i>
                        Logout</a></li>
