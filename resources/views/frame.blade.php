          ...
          <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
                  ...
                  <li><a class="@if(Route::currentRouteName() == 'shopping-list')  active @endif" href="{{ route('shopping-requests.index') }}">Shopping Requests</a></li>
                  <li><a class="@if(Route::currentRouteName() == 'shopping-list')  active @endif" href="{{ route('delivery-locations.index') }}">Delivery Locations</a></li>
