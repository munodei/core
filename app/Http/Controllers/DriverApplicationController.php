...
class DriverApplicationController extends Controller
{
    ...
    public function create()
    {
      ...
      $rules = [
                'fname'=>'required',
                'lname'=>'required',
                'email'=>'required|max:50|unique:driver_applications,email,'.$data->id,
                'phone'=>'required|max:20|unique:driver_applications,phone,'.$data->id,
                'resume_doc'=>'required',
                ...
                'mobile_phone'=>'required|max:20|unique:driver_applications,mobile_phone,'.$data->id
                                     ];
