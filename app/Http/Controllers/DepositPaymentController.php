...
class PaymentController extends Controller
{
    ...
    public function depositConfirm(Request $request)
    {
        ...
        if ($data->gateway_id == 101) {
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.stripe', compact('track', 'page_title'));
            }
        ...
        elseif ($data->gateway_id == 501) {
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.blockchain', compact('bitcoin', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.blockbtc', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.blocklite', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.blockdog', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.coinpaybtc', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.coinpayeth', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.coinpaybch', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.coinpaydash',compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.coinpaydoge', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
            ...
            if($user->merchant == 1)
            {
                return view('user.merchant-payment.coinpayltc', compact('bcoin', 'wallet', 'qrurl', 'page_title'));
            }
